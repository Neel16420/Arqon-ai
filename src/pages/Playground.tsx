...
export default function Playground() {
  const { selectedProviderId, setSelectedProviderId } = useRoutingSequence()
  ...
  const setSelectedProvider = setSelectedProviderId as (
    p: ModelProvider,
  ) => void
    ...
    <div className="flex flex-col h-full bg-background overflow-hidden animate-page-enter relative">
      ...
      {activeProviders.length === 0 ? (
        <EmptyState
          ...
          subtitle="Connect an API Key to activate providers and test models in the Playground."
        ...
        <>
          ...
          <div className="h-14 border-b border-border/40 bg-surface/30 backdrop-blur-md flex items-center justify-between px-6 shrink-0 relative z-10">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-sm font-semibold text-foreground font-space">
                Playground
              </h1>
            </div>
            <button
