...
const MOCK_HISTORY: HistoryItem[] = [
  {
    id: "1",
    prompt:
      "Write a highly optimized quick sort in TypeScript and explain its complexity.",
    provider: "openai",
    model: "GPT-4o",
    time: "2 mins ago",
    tokens: 409,
  ...
  {
    id: "2",
    prompt: "Translate this python script to Rust.",
    provider: "anthropic",
    model: "Claude Opus",
    time: "1 hour ago",
    tokens: 1250,
  ...
  },
  {
    id: "3",
    prompt:
      "Generate a JSON schema for a user profile with strict validation rules.",
    provider: "google",
  ...
  {
    id: "4",
    prompt: "Summarize the latest research on transformer memory efficiency.",
    provider: "mistral",
    model: "Mistral Large",
    time: "Yesterday",
    tokens: 2100,
        ...
        <>
          ...
          >
            <div className="flex items-center justify-between p-6 border-b border-border/40">
              <h2 className="text-sm font-semibold text-foreground font-space">
                Playground History
              </h2>
              <button
                onClick={onClose}
              ...
              {MOCK_HISTORY.map((item) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-4 text-[10px] text-muted border-t border-border/30 pt-3">
                    ...
                    <div className="flex items-center gap-1.5">
                      <DollarSign size={10} className="text-success/80" />{" "}
                      {item.cost}
                    </div>
                  </div>
                </button>
