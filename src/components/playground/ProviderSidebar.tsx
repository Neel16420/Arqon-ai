...
const PROVIDERS: ProviderInfo[] = [
  {
    ...
    latency: "240ms",
    context: "128k",
    models: ["GPT-4o", "GPT-4.1", "GPT-3.5-Turbo", "O1 Preview"],
  },
  {
    id: "anthropic",
    name: "Anthropic",
    latency: "350ms",
    context: "200k",
    models: ["Claude Opus", "Claude Sonnet 3.5", "Claude Haiku"],
  },
  {
    id: "google",
    name: "Google",
  ...
  },
  {
    ...
    latency: "210ms",
    context: "128k",
    models: ["Azure GPT-4o", "Azure Llama 3"],
  },
  {
    id: "mistral",
    name: "Mistral",
    latency: "190ms",
    context: "32k",
    models: ["Mistral Large", "Mistral Nemo", "Mixtral 8x22B"],
  },
  {
    id: "groq",
    name: "Groq",
  ...
  },
  {
    ...
    latency: "400ms",
    context: "Varies",
    models: ["Auto-Router", "Llama 3 405B", "Command R+"],
  },
]
