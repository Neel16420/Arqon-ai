...
export function ProviderDistribution({
  ...
  const slices = rawData.map((d, i) => {
    ...
    const drawDuration = shouldReduceMotion
      ? 0
      : Math.max(0.1, percentage * 0.9)
  ...
  return (
    ...
    >
      ...
      <h2 className="text-lg font-bold text-foreground font-space mb-1">
      ...
      <div className="flex-1 min-h-0 relative flex flex-col items-center">
        ...
        <div className="w-full h-[200px] flex items-center justify-center relative">
            ...
            {slices.map((slice, i) => {
              ...
              return (
                <motion.circle
                  ...
                  transition={{
                    strokeDashoffset: {
                      duration: slice.drawDuration,
                      delay: slice.delay,
                      ease: "easeOut",
                    },
                    scale: {
                      duration: 0.3,
                      delay: slice.delay + slice.drawDuration,
                      ease: "easeOut",
                    }, // Pop occurs right after drawing
          ...
          <motion.div
            ...
            transition={{
              delay: shouldReduceMotion ? 0 : currentDelay,
              duration: 0.4,
            }}
        ...
        <div className="w-full mt-6 space-y-1.5 overflow-y-auto custom-scrollbar pr-2 pb-2">
          {slices.map((slice, i) => (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{
                delay: shouldReduceMotion ? 0 : 0.8 + i * 0.04,
                duration: 0.3,
              }}
              onMouseEnter={() => setHoveredIndex(i)}
              onMouseLeave={() => setHoveredIndex(null)}
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <span className="font-mono text-muted group-hover:text-foreground transition-colors">
                  {slice.value}
                </span>
