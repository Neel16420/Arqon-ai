...
const PAGE_META: Record<Page, { title: string, desc: string }> = {
  overview: {
    title: "Overview",
    desc: "Platform health and traffic at a glance",
  },

  providers: {
    title: "Providers",
    desc: "Manage AI provider integrations and priorities",
  },
  ...
  settings: {
    title: "Settings",
    desc: "Platform configuration and admin access",
  },
  ...
  routing: {
    title: "Routing",
    desc: "Visual routing rules and failover chains",
  },

  analytics: {
    title: "Analytics",
    desc: "Usage metrics, latency trends, and cost analysis",
  },

  "api-keys": {
    title: "API Keys",
    desc: "Gateway authentication key management",
  },

  playground: {
    title: "Playground",
    desc: "Test models and providers interactively",
  },

  team: {
    title: "Team Management",
    desc: "Manage team members, roles, and organization access",
  },

  roles: {
    title: "Roles & Permissions",
    desc: "Configure granular role-based access control across all platform modules",
  },

  limits: {
    title: "Usage Limits",
    desc: "Set rate limits, token thresholds, and access restrictions per tier and model",
  },

  "audit-logs": {
    title: "Audit Logs",
    desc: "Enterprise governance tracking and real-time security compliance stream",
  },

  timeline: {
    title: "Activity Timeline",
    desc: "Chronological audit trail of ecosystem events, configuration changes, and routing updates",
  },
}
...
const notifications = [
  {
    id: 1,
    msg: "Azure OpenAI degraded — failover active",
    time: "2m ago",
    type: "warning",
  },
  ...
  {
    id: 2,
    msg: "Google AI quota at 96% capacity",
    time: "18m ago",
    type: "warning",
  },
  ...
  {
    id: 3,
    msg: "New provider Mistral Large added",
    time: "2h ago",
    type: "info",
  },
]
    ...
    >
      ...
      <div className="flex items-center gap-3 min-w-0">
        ...
        <div className="min-w-0">
          ...
          <p className="text-xs text-muted hidden md:block truncate">
            {meta.desc}
          </p>
        </div>
      </div>
        ...
        <div className="relative" ref={userMenuRef}>
          ...
          >
            <div
              ...
              style={{
                background: "#000000",
                boxShadow: "0 0 8px rgb(var(--color-accent-rgb) / 0.25)",
              }}
            >
              {session.userAvatar ? (
                <img
            ...
            <span className="text-xs font-medium text-foreground hidden sm:block truncate max-w-[120px]">
              {session.userName ? session.userName.split(" ")[0] : "Admin"}
            </span>
            <ChevronDown
              size={12}
          ...
          <div
            ...
            style={{
              ...
              transition:
                "transform 0.2s cubic-bezier(0.16, 1, 0.3, 1), opacity 0.15s ease",
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  background: "#000",
                  boxShadow: "0 0 10px rgb(var(--color-accent-rgb) / 0.2)",
                }}
              >
                {session.userAvatar ? (
                  <img
